...
- **On startup**, immediately populate your list with 3 items: check `gh issue list` for open work, check pending PRs, and your last known task from memory. Never start a session with an empty list.
...
- **Minimum 3 items** — if you have fewer, find more work from GitHub issues.
