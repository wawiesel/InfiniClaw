...
- **Removed tools** (2026-03-21): `send_message`, `register_group`, `crew_roster`, `list_recipients`, `set_thread`, `restart_wksm`, `check_health`, `query_local_llm`. MCP server renamed `nanoclaw` → `infiniclaw`.
