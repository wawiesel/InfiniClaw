...
| `metrics.test.ts` | Fleet metrics: rollingRate, SCORE_REACTIONS, operator/bot/ship/fleet metrics, scope routing, formatting. Bot names capitalized; ship header uses `shipTag()`. |
