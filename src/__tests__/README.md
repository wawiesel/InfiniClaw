...
| `interactive-bb.test.ts` | formatContextInjectionMessage: spec wording, trailing newline, empty message, special chars. buildReactivationObjective: original/follow-up/title inclusion, multi-line objectives, thread title header. |
