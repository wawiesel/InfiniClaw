...
- **Branch Brain terminology**: All user-facing strings use "Branch Brain" (not "Thread Brain"). Internal variable names (`spawnThreadBrain`, `threadBrainRestartTimers`, etc.) retain `thread` prefix for code stability — only comments, prompts, and Matrix-visible messages were renamed.
