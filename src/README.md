...
├── formatting.ts       → Message formatting helpers: capitalizeName, escapeHtml, statusMessage, formatBotDisplayName, PIP_FOR_STATUS, ROLE_ICONS, rankMedal, botBadge, isBotCO, shipHeaderLine, botTreeLine, GRADE_EMOJI, unifiedBotDisplay (short/medium/long verbosity, status-aware health via statusHealthEmoji)
