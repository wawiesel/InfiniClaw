...
- **Heartbeat nudge**: `heartbeatLoop()` nudges idle onduty bots to check GitHub issues for autonomous work. Message includes `<m>Name</m>` markers so it matches the callout trigger pattern. See [04-ship](../docs/design/04-ship.md).
