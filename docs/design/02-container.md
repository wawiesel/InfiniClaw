...
**Branch brains** run on the host (not inside containers). The relay spawns them as `claude --print` processes that communicate via Matrix threads. See [07-threading](07-threading.md).
