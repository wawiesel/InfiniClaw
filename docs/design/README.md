...
- `12-co.md` — Chain of command (CO/XO/Chief), Chief election and delegation, Work Breakdown Structure (WBS) — per-room task list with dependencies, relay integration implemented (startup inject, reabsorb, heartbeat auto-assign, wbs_complete), Chief content management pending
