...
- `17-skills.md` — Pooled capability modules per role; role-level loading implemented (symlinks into session); per-bot custom skills not yet auto-loaded; pm skill WBS path corrected to `wbs-{room}.json`
