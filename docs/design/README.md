...
- `21-cross-machine-health.md` — Cross-machine health protocol: 5-min beacon flush, `HealthReport` extensions, LIVE/STALE/OFFLINE classification, fleet aggregation, `check_health(scope=fleet)`. **✅ Implemented** (all 6 steps, `feat/wbs-relay`). Status block in doc updated.
