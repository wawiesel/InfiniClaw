...
- `14-configuration.md` — CLAUDE.md layers (3 separate files, not concatenated; base ro at allow-list mount, persona rw, room ro), MCP per-role config, startup checklist (aspirational — actual boot is a system resume message with active todos + last 5 messages)
