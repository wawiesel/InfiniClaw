...
- `01-matrix.md` — Matrix server, accounts (@operator, @loudspeaker, @help, intercom), room setup, message format, `<m>` mention pills (Captain/operator raw `@Name` conversion), reactions (📡/👀/🔔), special mentions, verification
