...
- **Signal-driven spawn** — the bot outputs `{{branch title="X" objective="Y"}}` inline. The relay strips the signal, posts the remaining text as the 🌿 thread header, and spawns the BB.
